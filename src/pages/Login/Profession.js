          ...
          renderItem={({ item }) => (
            <View style={styles.item}>
              <Text style={{ color: 'white', fontSize: 15, marginBottom: 5 }}>
                {item.title}
                <Text style={{ color: '#737082', fontSize: 13 }}>
                  {item.subtitle}
                </Text>
              </Text>
              <View style={{ flexDirection: "row", maxWidth: 400, margin: 0, flexWrap: "wrap" }}>
                <View>
                  <Text style={{ ...styles.TextBorder, backgroundColor: '#737082', color: '#FFB72B', width: 120 }}>Musica Eletrônica</Text>
                </View>
                <View>
                  <Text style={{ ...styles.TextBorder, backgroundColor: '#737082', color: '#18142F', width: 120 }}>Pop Internácional</Text>
                </View>
                <View>
                  <Text style={{ ...styles.TextBorder, backgroundColor: '#737082', color: '#F2C8DC', width: 50 }}>Forrô</Text>
                </View>
                <View>
                  <Text style={{ ...styles.TextBorder, backgroundColor: '#737082', color: '#C70047', width: 80 }}>Carismático</Text>
                </View>
                <View>
                  <Text style={{ ...styles.TextBorder, backgroundColor: '#737082', color: '#0008A4', width: 100 }}>Pop Nácional</Text>
                </View>
                <View>
                </View>
              </View>
