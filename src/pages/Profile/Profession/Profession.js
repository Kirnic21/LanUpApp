...
class Profession extends Component {
  ...
  openAddAbiliity = () => {
    this.props.navigation.navigate('AddAbiliity');
  }
              ...
              renderItem={({ item }) => (
                <View style={styles.item}>
                  ...
                  >
                    ...
                    <View>
                      <Text style={{
                        ...styles.TextBorder, backgroundColor: '#737082', width: 100, fontSize: 13,
                      }}
                      >Bartender
                      </Text>
                    </View>
                    ...
                    <View>
                      <Text style={{
                        ...styles.TextBorder, backgroundColor: '#737082', width: 140, fontSize: 13,
                      }}
                      >Serviços Gerais
                      </Text>
                    </View>
