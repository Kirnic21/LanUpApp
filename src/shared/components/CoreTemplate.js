...
export default CoreTemplate = props => (
  <View style={styles.logoContainer}>
    ...
    <ImageBackground source={ImageBack} style={styles.ImageBackgroundContainer}>
      {props.name && (
        <View style={{ display: "flex", marginTop: 120, marginLeft: 0 }}>
          <ImageBackground
          ...
          <View style={{ top: -70, display: "flex" }}>
            <Text
              style={{ color: "#FFB72B", textAlign: "right", fontSize: 22 }}
            >
              {props.subtitle}
            </Text>
          </View>
